...
// Get all students who have paid class fees
$paid_ids = [];
$paid_res = mysqli_query($conn, "SELECT DISTINCT student_id FROM classes_fees");
...
<html>
<head>
    <title>Unpaid Classes Fees Students</title>
...
<div class="container" style="margin-top:40px;">
    <h2><i class="fa fa-times-circle"></i> Unpaid Classes Fees Students</h2>
    <a href="classes_fees.php" class="btn btn-default"><i class="fa fa-arrow-left"></i> Back</a>
    <form class="filter-form" method="get" action="unpaid_classes.php">
        ...
        <?php if ($filter_class || $filter_name): ?>
            <a href="unpaid_classes.php" class="btn btn-default btn-xs">Clear</a>
        <?php endif; ?>
    </form>
