...
// Get all students who have paid PTA levy
$paid_ids = [];
$paid_res = mysqli_query($conn, "SELECT DISTINCT student_id FROM pta_levy");
...
<html>
<head>
    <title>Unpaid PTA Levy Students</title>
...
<div class="container" style="margin-top:40px;">
    <h2><i class="fa fa-times-circle"></i> Unpaid PTA Levy Students</h2>
    <a href="pta_levy.php" class="btn btn-default"><i class="fa fa-arrow-left"></i> Back</a>
    <form class="filter-form" method="get" action="pta_levy_unpaid.php">
        ...
        <?php if ($filter_class || $filter_name): ?>
            <a href="pta_levy_unpaid.php" class="btn btn-default btn-xs">Clear</a>
        <?php endif; ?>
    </form>
