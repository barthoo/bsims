...
$query = "
    SELECT s.admission_no, s.first_name, s.other_names, s.class, t.amount, t.description, t.date_paid
    FROM tuition_fees t
    LEFT JOIN students s ON t.student_id = s.admission_no
";
$conditions = [];
if ($filter_class) {
...
<html>
<head>
    <title>Paid Tuition Fees Students</title>
    ...
    <style>
        ...
        .table th { background: #0e7490; color: #fff; }
        .btn-back { margin-bottom: 18px; }
    </style>
</head>
<body>
<div class="main-container">
    <h2><i class="fa fa-check-circle"></i> Paid Tuition Fees Students</h2>
    <a href="tuition_fees.php" class="btn btn-default btn-back"><i class="fa fa-arrow-left"></i> Back</a>
    <form class="filter-form" method="get" action="paid_tution_fees.php">
        ...
        <?php if ($filter_class || $filter_name): ?>
            <a href="paid_tution_fees.php" class="btn btn-default btn-xs">Clear</a>
        <?php endif; ?>
    </form>
