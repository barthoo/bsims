...
// Get all students who have paid sports levy
$paid_ids = [];
$paid_res = mysqli_query($conn, "SELECT DISTINCT student_id FROM sports_levy");
...
<html>
<head>
    <title>Unpaid Sports Levy Students</title>
...
<div class="container" style="margin-top:40px;">
    <h2><i class="fa fa-times-circle"></i> Unpaid Sports Levy Students</h2>
    <a href="sports_levy.php" class="btn btn-default"><i class="fa fa-arrow-left"></i> Back</a>
    <form class="filter-form" method="get" action="unpaid_sports_levy.php">
        ...
        <?php if ($filter_class || $filter_name): ?>
            <a href="unpaid_sports_levy.php" class="btn btn-default btn-xs">Clear</a>
        <?php endif; ?>
    </form>
