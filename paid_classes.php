...
// Fetch paid students (filtered by class and name if selected)
$query = "
    SELECT s.admission_no, s.first_name, s.other_names, s.class, f.amount, f.description, f.date_paid
    FROM classes_fees f
    LEFT JOIN students s ON f.student_id = s.admission_no
";
$conditions = [];
if ($filter_class) {
...
<html>
<head>
    <title>Paid Classes Fees Students</title>
    ...
    <style>
        ...
        h2 { color: #2563eb; font-weight: 700; margin-bottom: 24px; }
...
<div class="main-container">
    <h2><i class="fa fa-check-circle"></i> Paid Classes Fees Students</h2>
    <a href="classes_fees.php" class="btn btn-default btn-back"><i class="fa fa-arrow-left"></i> Back</a>
    <form class="filter-form" method="get" action="paid_classes.php">
        ...
        <?php if ($filter_class || $filter_name): ?>
            <a href="paid_classes.php" class="btn btn-default btn-xs">Clear</a>
        <?php endif; ?>
    </form>
